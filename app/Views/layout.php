...
<head>
  ...
  <title>Delishdose | <?php echo $hlm ?></title>
  <meta content="" name="description">
  <meta content="" name="keywords">

  <!-- Favicons -->
  <link href="<?= base_url()?>NiceAdmin/assets/img/logo-delishdose.png" rel="icon">
  <link href="<?= base_url()?>NiceAdmin/assets/img/logo-delishdose.png" rel="apple-touch-icon">
